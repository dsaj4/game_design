...
7. 检查清单：读者能自行判断“是否完成”。
8. 项目应用边界：说明适用情境与验证要求；具体转化、假设和决定留在独立工作区。
...
7. **写项目转化**：先选择独立工作区，再记录适用关系与待验证假设；共享知识不保存项目专属设定，不直接改核心构思。
...
| 通用原则与当前项目冲突 | 误导目标工作区的设计判断 | 所有项目转化在目标工作区先写 Hypothesis，按既有提案流程处理 | 进入 GDD 前 |
