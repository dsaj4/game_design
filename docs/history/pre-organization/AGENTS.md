...
> 原路径：`AGENTS.md`。本副本仅调整相对链接，原字节SHA见整理清单。
...
当前默认工作区是 game-002，核心为 Core Concept v0.6 的战前法术编排与自动战斗；具体状态以项目文档为准。
...
```text
这个仓库管理互相独立的游戏构思，用来把灵感、调研和判断沉淀成可追踪的设计结论。当前默认 game-002 的核心为战前法术编排与自动战斗，具体状态以项目文档为准。
