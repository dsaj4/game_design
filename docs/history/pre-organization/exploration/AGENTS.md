...
> 原路径：`exploration/AGENTS.md`。本副本仅调整相对链接，原字节SHA见整理清单。

# 玩法探索区操作规则

继承根 AGENTS.md 的 Git 保护、素材资格、来源追踪和设计/代码隔离。管理决定见[WS-004](../../../workspace-decisions.md)。本文件补充探索区路径，不修改 game-002 的玩法协议。

## 路由与读取范围

1. 先读本区 README、[项目注册表](../../../../exploration/registry/project-registry.md)，确定唯一 Project ID 和项目根 P。
