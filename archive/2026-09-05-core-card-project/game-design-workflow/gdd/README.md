...
本目录保存按照 [GDD 写作要求与模板](../../../../game-design-workflow/templates/gdd-writing-requirements-and-template.md)形成的具体 GDD。
...
- [GDD-BATTLE-001：唯一核心卡成语组合战斗系统](../../../2026-08-24-gdd-code-separation/GDD-2026-08-21-card-battle-system.md) — `Parked / Archived`，保留旧流程下的设计与代码证据。
