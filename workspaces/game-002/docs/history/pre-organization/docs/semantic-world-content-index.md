...
- 召唤类型可识别，但完整召唤流程依既有范围后置。复杂传播及材料/空间加工仍后置；镶嵌固定身份模型已明确，其余规则见[完整候选](../../../../game-design-workflow/idea-materials/M-2026-09-12-wand-inlay-system.md)。
...
[四层数值框架](../../../../game-design-workflow/idea-materials/M-2026-09-11-numerical-evaluation-framework.md)已建立；用户随后要求[全局审查](../../../global-rules-audit-2026-09-11.md)，GR处理方式已按[G002-CORE-015](../../../../game-design-workflow/idea-materials/M-2026-09-11-global-rule-boundaries.md)采纳，当前先补[修饰词与镶嵌](../../../modifier-and-inlay-design.md)，再回归[卡牌与流派流程](../../../card-design-review-workflow.md)。测试积累后合批；旧词效保持Parked，新设计按资格流程逐项推进。
