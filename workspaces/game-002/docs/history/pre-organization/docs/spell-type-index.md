...
| 后续工作 | 全局文档审查已完成，先补[修饰词与镶嵌](../../../modifier-and-inlay-design.md)，之后进入卡牌／流派候选；按已采纳GR处理补具体卡牌字段，测试积累后合批；类型扩展检查要求保留 |
...
形容词与副词是词卡子类。按[Modifier v0.1](../../../../game-design-workflow/idea-materials/M-2026-09-11-modifier-card-system.md)，“获得寒冷的护甲”为简易＋状态，“寒冷的寒冰吞噬护甲”为元素＋状态；“寒冷的”挂火焰不兼容，不能作为合法法术。具体词效另查，寒冰／冰霜尚未合并。
