...
2026-09-13当前：RC01–12已采纳；首版为S2全部25项、E3全部30项及完整局内流程。DG01–03、DG06–09已关闭，继续DG10阶段名单与顺序。最新采纳G002-CORE-025至027：环境转化继承、两种转化原地替换、地面保留及补生覆盖来源。详情见写作前设计缺口清单与决策记录；先定缺口，再写新GDD，当前不启动新玩法测试。
