...
下一步：澄清普通施法中的主动取消权限。推荐基础版开始施法后不提供通用取消动作，保留投入承诺，但接受战况变化或判断失误后更难挽回的代价；[主动取消候选](../game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#当前整体机制评议施法中的主动取消权限)仍为 Raw Idea / Unqualified。既有超限弃牌窗口的取消限制不等于此项已确认，具体能力、数值及界面后置。
