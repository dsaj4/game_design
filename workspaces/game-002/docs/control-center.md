...
日期：2026-09-10。状态：Active / Stable Design Baseline。核心Core Concept v0.6；当前范围修订G002-CORE-011，证据Hypothesis。

| 范围 | 当前结论 | 入口 |
| --- | --- | --- |
| 战前配置 | 完整库存构句，一组合一循环法术，一法术一法杖，0–10刻首次冷却 | [核心](../game-design-workflow/core-concept.md) |
| 自动战斗 | 实例/条件引用、固定单次名单、共享槽与覆盖、生命伤害打断、四阶段及胜利终止 | [执行规则](../game-design-workflow/idea-materials/M-2026-09-10-semantic-world-executable-rules.md) |
