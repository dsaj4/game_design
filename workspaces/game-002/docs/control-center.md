...
| 当前工作 | 已建效果登记：32项与67项案例；后续主动维护。Modifier及IN-A明确，IN-C仍Candidate，按实际依赖补齐再设计成套物品 | [效果登记](effect-registry/README.md)、[缺项审查](effect-registry/readiness-review.md)、[设计流程](card-design-review-workflow.md) |
...
| 素材状态 | 54份合格素材，30份inbox记录；分类采纳不提升被搁置词效的状态 | [素材](../game-design-workflow/idea-materials/README.md) |
