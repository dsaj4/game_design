...
下一步：讨论普通战斗在同一检查点同时满足全部敌人被击败与玩家生命耗尽时，是否按失败结束本局。[冲突裁定评议](../game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#当前整体机制评议同时满足胜负条件)仍为 Raw Idea / Unqualified；建议失败优先以保留生存要求，同归于尽无法收尾的策略代价待验证。
