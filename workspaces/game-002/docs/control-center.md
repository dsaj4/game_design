...
下一步：讨论每句法术或每次敌方行动完整结算后，是否立即检查击败与胜负，再处理下一事件。[检查时点评议](../game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#当前整体机制评议击败与胜负检查时点)仍为 Raw Idea / Unqualified；建议以完整行动为检查边界，需验证中途状态与最终结果的理解风险。
