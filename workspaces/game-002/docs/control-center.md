...
| 原始想法记录、素材、正式 GDD | 5 / 35 / 0（前三份初稿与循环记录，加灵活句式改动及商店金币记录；素材均为 Hypothesis） |
| 提案、评估、正式玩法决定 | 无 |
| 原型与代码 | 无 |
| 生产阶段、排期 | 未确定 |
...
当前改动（2026-09-07）：MQ1-MQ4 已整组确认，独立晋级[商品资格与道具持有上限](../game-design-workflow/idea-materials/M-2026-09-07-merchandise-eligibility-and-item-limits.md)，共 35 份素材，证据 Hypothesis。EC、MS 已有素材；商店节点与 GA 奖励方式仍未确认，同种持有上限不再列为未知。

下一步：集中确认 [MN1-MN4 商店节点与消费机会](../game-design-workflow/idea-inbox/2026-09-07-shop-and-time-based-gold.md#当前小板块商店节点与消费机会)；再重议 GA 奖励方式，数值、界面和实现后置。
