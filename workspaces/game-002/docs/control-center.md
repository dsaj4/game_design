...
| 原始想法记录、素材、正式 GDD | 3 / 16 / 0（包含双路线评议与 A 细化草案） |
| 提案、评估、正式玩法决定 | 无 |
| 原型与代码 | 无 |
| 生产阶段、排期 | 未确定 |
...
当前改动（2026-09-06）：[灵活句式、词性复用与多法术类型](../game-design-workflow/idea-inbox/2026-09-06-flexible-grammar-and-spell-types.md)中的 SG、FG、ST、SL、SH 及 SC1-SC6 [召唤关联卡生成与入手](../game-design-workflow/idea-materials/M-2026-09-06-summon-reference-generation-and-hand-entry.md)已分别晋级，正式素材共 23 份，证据 Hypothesis；单位共存与容量、卡包适配及其他候选继续复审。

下一步：集中确认 [SN1-SN5](../game-design-workflow/idea-inbox/2026-09-06-flexible-grammar-and-spell-types.md#当前小板块召唤物共存与场上容量)，明确召唤物共存与场上容量；具体上限数字、词卡数值和界面后置。
