...
下一步：讨论基础版普通敌人是否以检查点上生命耗尽作为击败条件，无需额外清空护甲或状态。[击败条件评议](../game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#当前整体机制评议普通敌人击败条件)仍为 Raw Idea / Unqualified；建议统一基础目标，具体伤害与护甲规则后置，敌人差异和状态操作价值待验证。
