...
| 原始想法记录、素材、正式 GDD | 5 / 36 / 0（前三份初稿与循环记录，加灵活句式改动及商店金币记录；素材均为 Hypothesis） |
| 提案、评估、正式玩法决定 | 无 |
| 原型与代码 | 无 |
| 生产阶段、排期 | 未确定 |
...
当前改动（2026-09-07）：MN1-MN4 已独立晋级[商店节点与消费机会](../game-design-workflow/idea-materials/M-2026-09-07-shop-nodes-and-spending-opportunities.md)，共 36 份素材，证据 Hypothesis。EC、MS、MQ、MN 已补齐商店与金币基础机制；首次购买力目标未验证，当前回到道具奖励方式复审。

下一步：集中确认 [GR1-GR4 战斗道具奖励](../game-design-workflow/idea-inbox/2026-09-06-flexible-grammar-and-spell-types.md#当前小板块战斗道具奖励复审)；其后补具体道具与奖励节奏，数值、界面和实现后置。
