...
下一步：讨论普通敌人被判定击败后，是否立即取消其尚未执行的普通行动并停止后续准备。[击败后果评议](../game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#当前整体机制评议击败敌人与待执行行动)仍为 Raw Idea / Unqualified；需验证优先消灭威胁换取施法空间的价值，以及集中攻击压过其他策略的风险。
