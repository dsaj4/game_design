...
| 原始想法记录、素材、正式 GDD | 5 / 34 / 0（前三份初稿与循环记录，加灵活句式改动及商店金币记录；素材均为 Hypothesis） |
| 提案、评估、正式玩法决定 | 无 |
| 原型与代码 | 无 |
| 生产阶段、排期 | 未确定 |
...
当前改动（2026-09-07）：EC1-EC4 金币机制已有独立素材；MS1-MS5 已整组确认并独立晋级[商店货架与交易](../game-design-workflow/idea-materials/M-2026-09-07-shop-shelves-and-transactions.md)，正式素材共 34 份，证据 Hypothesis。商品资格与重复、节点安排和 GA 奖励仍未确认。

下一步：集中确认 [MQ1-MQ4 商品资格与重复限制](../game-design-workflow/idea-inbox/2026-09-07-shop-and-time-based-gold.md#当前小板块商品资格与重复限制)；再补商店节点安排及 GA 联动，数值、界面和实现后置。
