...
| 原始想法记录、素材、正式 GDD | 4 / 27 / 0（前三份初稿与循环记录，加灵活句式改动；素材均为 Hypothesis） |
| 提案、评估、正式玩法决定 | 无 |
| 原型与代码 | 无 |
| 生产阶段、排期 | 未确定 |
...
当前改动（2026-09-06）：[灵活句式、词性复用与多法术类型](../game-design-workflow/idea-inbox/2026-09-06-flexible-grammar-and-spell-types.md)中的 SG、FG、ST、SL、SH、SC、SN、SR、WC 及 OH1-OH5 [开局手牌保障与可表达性](../game-design-workflow/idea-materials/M-2026-09-06-opening-hand-guarantees.md)已分别晋级，正式素材共 27 份，证据 Hypothesis；开局保障与随机补正已明确，整句效果与其他词义继续复审。

下一步：集中确认 [SM1-SM3](../game-design-workflow/idea-inbox/2026-09-06-flexible-grammar-and-spell-types.md#当前小板块整句效果与词义复用)，明确整句效果组成与词义复用；具体词卡、数值和界面后置。
