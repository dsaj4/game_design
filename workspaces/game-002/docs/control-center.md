...
| 当前工作 | Modifier v0.1与镶嵌IN-A模型已明确；审阅IN-C01–14完整候选，之后设计流派成套物品 | [修饰词与镶嵌](modifier-and-inlay-design.md)、[设计—评测—采纳](card-design-review-workflow.md) |
...
| 素材状态 | 52份合格素材，27份inbox记录；分类采纳不提升被搁置词效的状态 | [素材](../game-design-workflow/idea-materials/README.md) |
...
当前先补修饰词与镶嵌；系统齐备后按可扩展的已采纳类型交叉索引设计卡牌与流派，一条规则只维护一份。未指定类型时先整理简易类，涉及状态、元素或召唤名词时同时列出相关类型。
