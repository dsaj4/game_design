...
| 原始想法记录、素材、正式 GDD | 3 / 11 / 0（包含双路线评议与 A 细化草案） |
| 提案、评估、正式玩法决定 | 无 |
| 原型与代码 | 无 |
| 生产阶段、排期 | 未确定 |
...
下一步：集中评议[伤害、护甲与打断](../game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#当前小板块评议伤害护甲与打断)的 D1-D4：直接伤害的护甲流程、全额抵挡是否打断、持续伤害是否经过护甲、持续伤害是否打断。四项均为 Raw Idea / Unqualified，可整组确认或逐项调整；具体词卡、状态节拍与数值后置。
