...
| [EG实际火冰阈值与双痕迹](../../game-design-workflow/idea-inbox/2026-09-14-environment-forms-and-thresholds.md) | FX-061／062的候选细化，最终转化依FX-065 | Raw／待审；不凭场景表认定已测 |
| [RG普通／首领完整疲劳](../../game-design-workflow/idea-inbox/2026-09-14-run-route-encounters-and-fatigue.md) | 基础世界规则沿BR08，不新增可装配FX | 新参数及前提待审；数学上界不是运行验证 |
...
来源：[元素第二期机制卡池](../../game-design-workflow/idea-inbox/2026-09-13-element-spell-mechanism-card-pool-02.md)。旧期保留；类型依据完整句而非输出效果，下面仅是语义示例。
...
来源：[第三期短规则卡池](../../game-design-workflow/idea-inbox/2026-09-13-element-spell-symbol-card-pool-03.md)。完整78条旧卡去向在来源附表；符号不是新句法，退出本期不删除旧案例。第二期实际30项，修正原32项计数。
...
元素E3的30项旧行在当时标为Raw，现已由用户确认并晋级[已确认元素E3素材](../../game-design-workflow/idea-materials/M-2026-09-13-element-short-rule-card-pool.md)；当前使用状态为Confirmed／Qualified，未升级旧变体或参数。以下[简易短规则卡池](../../game-design-workflow/idea-inbox/2026-09-13-simple-spell-short-rule-card-pool.md)仍Raw。
