...
- [语义世界内容入口](semantic-world-content-index.md)：已采纳对象范围、候选与Parked状态索引。
...
- [效果注册与理清](effect-registry/README.md)：69项效果／方向、67项案例、来源、边界及交接门槛；后续讨论主动登记，状态与验证分别判断。

- [第一人称战场与环境](battlefield-and-environment.md)：GDD-1／Draft Change，两排占位、地面、有限火焰作用与阶段变化；用户明确方向和推荐细则分开。
