...
**休整构筑分支**：
休整中用于改善本局卡组的选择，取得该收益会放弃本次恢复生命的机会；具体改善方式尚未确定。来源同[休整素材](game-design-workflow/idea-materials/M-2026-09-05-rest-recovery-deck-choice.md)。
_Avoid_：将“改善卡组”直接当作升级、永久删牌或换牌已获采用。
