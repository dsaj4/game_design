...
**本局卡组**：
当前一局中用于组成各场战斗的词卡集合；战斗之间选择收下的普通新词直接加入其中，基础版不另设可每战免费换牌的备用词库。本场移除不改变其成员归属，来源见[新词入组素材](game-design-workflow/idea-materials/M-2026-09-05-new-word-deck-inclusion.md)。
