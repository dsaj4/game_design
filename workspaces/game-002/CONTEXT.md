...
**休整随机卡包**：
选择拿牌后才开启并公开主语、谓语、宾语各一张候选的随机卡包，各类内部随机、互不重名，并排除本局同名已满三张的词；跨卡包仍可出现未满额已有词。卡池权重、稀有度、某类无合格候选时的处理及重抽规则仍待定，来源见[三类各一张确认](game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#休整卡包三类各一张确认记录)。
