...
**提前施法**：
满足其他施法条件时，即使所引用状态尚未出现，也允许先投入词句并开始施法，预判材料会在需要时出现。词卡、语义兼容与目标合法性要求仍在，法术照常耗时并受命中打断约束；启动不提前制造、预留或保证获得状态，材料缺失的结果尚未确定。来源见[提前施法确认](game-design-workflow/idea-inbox/2026-09-05-yanzhou-core-combat.md#提前施法确认记录)。
