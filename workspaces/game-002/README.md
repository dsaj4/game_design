...
EG／RG已实际补环境形态阈值、6普通＋首领路线、12遭遇、生命／休整与完整疲劳候选；PG按原木杖不售的新推荐至v0.2，历史取值保留。UX已补完整流程、观看时间、平台范围和功能资产；[26组总审](docs/pre-gdd-content-review-2026-09-14.md)已列明实际候选与剩余关闭动作。新选择仍待审，下一步补规范化验收输入和真实资源基准；不以候选已写代替采用或验证。
