...
[完整GDD（0–18章）](GDD.md) · [版本清单](baseline.md) · [待决问题](../../../docs/design-decisions-needed.md)
...
原26组选择Closed / Accepted；AUD-010为本次发现的待消歧边界。完整RC1玩法／平衡／真人理解未完成验收。新探索保持独立：[方向索引](../../../../../exploration/game-002-optimization/directions/README.md)。
...
[规则ID定位](../../../docs/governance/rule-index.md)提供细节入口。交互展示由已确定规则产生，不能自行改变时序、资源和胜负。
