...
此前：[单卡参数与渠道](2026-09-14-first-release-parameters-and-channels.md)：Raw／PG v0.1，覆盖34词、19镶嵌、3杖；全局输入仍待补齐。
...
当前47份inbox记录；新增[全游戏GDD准备与用户选择](2026-09-13-full-game-gdd-preparation.md)。[RC推荐](2026-09-13-card-pool-rule-recommendations.md)与[S2原池](2026-09-13-simple-spell-short-rule-card-pool.md)已各按明确范围晋级，原记录保留。

共39份Markdown记录。已晋级部分链接正式素材；未明确内容保持Raw Idea / Unqualified或Parked。Source Only只提供追溯，不能作为参数来源。

| 记录 | 状态 |
| --- | --- |
| [首版界面、平台与体验](2026-09-14-interface-platform-and-experience.md) | Raw：三步编排、跨战实例处理、观看／保存、0.5秒刻、U01–08与实际功能资产，待选择 |
...
| [元素第二期机制卡池](2026-09-13-element-spell-mechanism-card-pool-02.md) | Raw：6名词／8新动词／6形容词／10新镶嵌，共30项；机制创新优先，第一期保留。FX-097–114登记，未采纳局部例外。 |
...
| [核心战斗与局内流程素材入口](2026-09-05-yanzhou-core-combat.md) | 状态：Promoted（仅对应明确素材）；其余 Raw Idea / Unqualified。Project ID：game-002。 |
| [句式、状态、类型与召唤素材入口](2026-09-06-flexible-grammar-and-spell-types.md) | 状态：Promoted（仅对应明确素材）；其余 Raw Idea / Unqualified。Project ID：game-002。 |
| [支撑系统与流派审查入口](2026-09-07-global-baseline-lock-review.md) | 状态：Promoted（仅对应明确素材）；其余 Raw Idea / Unqualified。Project ID：game-002。 |
| [镶嵌获取与收益边界](2026-09-07-inlay-acquisition-boundary.md) | 状态：Raw Idea / Unqualified；已列入当前镶嵌待讨论，具体获取未采纳。 |
| [数值重新设计来源入口](2026-09-07-numerical-calibration-candidates.md) | 状态：Source Only；具体参数Unknown，重新设计已确认。证据：Hypothesis。 |
| [数值设计审查入口](2026-09-07-numerical-design-review.md) | 状态：Source Only；数值重新设计已确认，参数Unknown。Project ID：game-002。 |
| [商店与战斗收益素材入口](2026-09-07-shop-and-time-based-gold.md) | 状态：Promoted（仅对应明确素材）；其余 Raw Idea / Unqualified。Project ID：game-002。 |
...
| [效果注册登记与理清](2026-09-12-effect-registry.md) | Promoted：设计工作流已授权；具体效果保持各自状态 |

当前按[类型入口](../../docs/spell-type-index.md)推进。四类特征已采纳且可以扩展；上一批具体词效与参数保持Parked，攻防候选的限定计算已复核，四层框架和全局文档审查已形成，已建立效果登记，修饰词与镶嵌按实际依赖补齐，之后回归卡牌／流派候选；候选不得静默写入正式GDD。前次内容与关键规则的原始输入保存在[快照](../../../../archive/2026-09-10-game-002-semantic-simplification-inputs/INDEX.md)。
