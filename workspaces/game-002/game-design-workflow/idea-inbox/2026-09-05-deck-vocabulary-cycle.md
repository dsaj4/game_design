...
已明确的局间构筑包括收下普通新词，以及跳过普通战斗词卡奖励；休整已补充随机卡包三张候选词卡选一张，仍与恢复互斥。拿牌改变以后能形成的句子以及组件出现机会。升级按用户要求暂缓，永久移除未确认；普通词卡弃置不会永久缩小本局卡组。卡包公开时机、候选生成与超限处理、休整跳过等另议，来源见[随机卡包确认](2026-09-05-yanzhou-core-combat.md#休整随机卡包三选一确认记录)。局外解锁与持久成长继续保持未定。
