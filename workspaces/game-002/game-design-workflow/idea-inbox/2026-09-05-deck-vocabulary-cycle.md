...
已明确的局间构筑包括收下普通新词，以及跳过普通战斗词卡奖励；休整已补充随机卡包三张候选词卡选一张，仍与恢复互斥。拿牌改变以后能形成的句子以及组件出现机会。升级按用户要求暂缓，永久移除未确认；普通词卡弃置不会永久缩小本局卡组。后续已明确先选分支再开包、开包后可全部放弃，候选排除本局同名已满三张的词，放弃不返还恢复机会；来源见[开包与过滤确认](2026-09-05-yanzhou-core-combat.md#休整先选分支开包与候选过滤确认记录)。同包重名、词类分布、过滤后候选不足等另议。局外解锁与持久成长继续保持未定。
