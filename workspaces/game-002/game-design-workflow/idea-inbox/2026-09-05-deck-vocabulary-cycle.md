...
- [ ] 当前评议[击败与胜负检查时点](2026-09-05-yanzhou-core-combat.md#当前整体机制评议击败与胜负检查时点)：每句法术或每次敌方行动完整结算后立即检查。
