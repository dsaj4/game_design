...
| 同刻结算 | 法术完成及弃牌 → 敌方行动及打断弃牌 → 到时状态 → 固定补牌与超限弃牌；中间不开新施法；状态阶段见[后续确认](2026-09-05-yanzhou-core-combat.md#单份周期状态计时与到期整组确认记录) | 多敌人及多个状态各自内部先后、连锁触发 |
...
- [ ] 集中评议[多敌人同刻行动顺序](2026-09-05-yanzhou-core-combat.md#当前小板块评议多敌人同刻行动顺序)E1-E3。
