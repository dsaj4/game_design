...
- [ ] 按[灵活句式、词性复用与多类型改动](2026-09-06-flexible-grammar-and-spell-types.md)重议旧 L1-L3，SG1-SG5、FG1-FG5、ST1-ST6、SL1-SL6、SH1-SH6、SC1-SC6 和 SN1-SN5 已分别独立晋级，当前确认 SR1-SR6 的召唤词引用与目标锁定；起手、卡包适配与下限数值仍后续明确，关联卡不增加删牌安全余量已由 SL6 确认。
