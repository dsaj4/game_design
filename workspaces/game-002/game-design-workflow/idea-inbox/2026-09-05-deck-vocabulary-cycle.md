...
当前工作：[敌方行动后的时间轴延续](2026-09-05-yanzhou-core-combat.md#敌方行动后时间轴延续确认记录)已确认并扩充素材，[敌方意图的确定与变更](2026-09-05-yanzhou-core-combat.md#敌方意图确定与变更确认记录)也已确认；[战场状态的跨行动保留](2026-09-05-yanzhou-core-combat.md#战场状态跨行动保留确认记录)也已确认并独立晋级；当前澄清[状态引用与消耗的关系](2026-09-05-yanzhou-core-combat.md#当前整体机制评议状态引用与消耗的关系)。
...
- [ ] 当前澄清状态引用与消耗的关系，继续推进状态再利用与供给的机制关系。
