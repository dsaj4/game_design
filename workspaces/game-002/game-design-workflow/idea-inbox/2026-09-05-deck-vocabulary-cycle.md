...
- [ ] 当前评议[同时满足胜负条件](2026-09-05-yanzhou-core-combat.md#当前整体机制评议同时满足胜负条件)：普通战斗同一检查点两项条件均成立时，按失败结束本局。
