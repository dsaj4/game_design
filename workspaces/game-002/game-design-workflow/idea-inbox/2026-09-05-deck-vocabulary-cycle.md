...
- [ ] 集中评议[状态读值与同刻内部顺序](2026-09-05-yanzhou-core-combat.md#当前小板块评议状态读值与同刻内部顺序)T1-T5。
