...
- [ ] 当前评议[击败敌人与待执行行动](2026-09-05-yanzhou-core-combat.md#当前整体机制评议击败敌人与待执行行动)：被判定击败后取消其待执行普通行动，并停止后续准备。
