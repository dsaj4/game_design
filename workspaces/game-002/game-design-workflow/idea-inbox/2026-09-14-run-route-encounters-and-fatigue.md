...
一刻对应秒数、观看倍速、决策用时和整局现实分钟数留给功能流程／体验表；不能仅凭80／120逻辑刻声称等待体验达标。
...
补实际界面与交互、秒／刻及体验目标、首版平台／发行范围和功能资产表；按全部候选依赖逐项审阅，已确认部分及时晋级。全部写作前缺口收束后再写GDD Wiki，不把候选文档或数学推导当作GDD已完成。
