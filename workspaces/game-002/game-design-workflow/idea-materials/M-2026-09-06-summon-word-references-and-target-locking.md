...
当前战前固定目标与战中生成单位的绑定接口为C03。未来单位占位、条件引用或预置单位均须用户决定，不能据此认定已有完整召唤指挥流程。
...
| --- | --- | --- | --- | --- |
| 战前构句怎样明确尚未生成单位的身份与范围。 | 影响完整设计与效果可解释性 | 用先召唤后指挥的两条循环法术逐刻列出身份、容量和范围所需前提。 | 玩家可预测结果，关键情境有唯一裁定 | 结果依赖未确认规则，或一类选择长期无价值 |
