...
最新：[批量采纳文本](D-2026-09-13-pre-gdd-recommendation-batch.md)；已采纳CORE-029、SCOPE-004、DOC-002；历史库保留。
...
- [稳定设计基线的当前适用范围](D-2026-09-09-core-system-stable-baseline.md)
...
- [实例绑定与条件绑定采纳](D-2026-09-10-instance-and-conditional-binding.md)：SW02 / G002-CORE-008，保留模型采纳时文本；名单后续已明确，R01–R32后续补齐执行框架。
- [单次释放直接对象名单采纳](D-2026-09-10-single-release-target-list.md)：SW02-A / G002-CORE-009，本次名单开始处理时确定，不追加、重选或补位；逐对象读取当前合法性与材料。
- [语义世界执行规则采纳：R01–R32 / G002-CORE-010](D-2026-09-10-semantic-world-executable-rules.md)。

- [当前简单对象交互采纳](D-2026-09-10-simple-object-interactions.md)：G002-CORE-011，收束位移/结构/材料加工并新增元素生成物与对象掉卡。此前文件保留采纳或评估时记录，当前范围以本项为准。

- [法术类型系统采纳](D-2026-09-11-spell-type-system.md)：G002-CORE-012，四类特征、多类型及按类型组织；上一批具体词效与参数Parked。
...
- [每刻末状态与自然衰减](D-2026-09-13-end-tick-status-rulings.md)：G002-CORE-018已采纳，固定顺序、累计扣层与允许储层；新规则NotRun。
