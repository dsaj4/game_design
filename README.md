...
- **[game-002：《言咒》](workspaces/game-002/README.md)**：默认独立工作区，Core Concept v0.6 / Stable Design Baseline。完整库存战前构句、循环法术与法杖配置、自动战斗及整体战后收益已形成核心；42份合格素材，证据Hypothesis。语义世界对象范围SW01已确认，当前推进SW02新生对象引用。入口为[设计决定与后续工作](workspaces/game-002/docs/design-decisions-needed.md)和[文档验收](workspaces/game-002/docs/design-alignment-audit.md)。
