...
本目录独立于 `game-design-workflow/`，用于系统学习游戏设计理论、分析同类产品，并把学习成果转化为本项目可验证的设计假设。

当前项目导向：

`唯一核心卡驱动的整体系统 + 重新设计中的关键冲突解决层`

旧“成语组合 + 攻防共享战斗能量 + 轮流回合制”方案已归档。当前研究应优先帮助新战斗 GDD-0 回答核心动作、目标、反馈、核心卡关系和地图接口，不得把旧规则当成默认前提。
...
- 不只收藏材料，必须产出摘要、问题或假设。
- 理论总结要能回答“它如何改变本项目设计判断”。
- 产品分析不追求百科式完整，优先拆解机制、动态、玩家体验。
- 横向对比要寻找模式，而不是列优缺点。
- 设计假设必须可验证，能进入提案或原型测试。
