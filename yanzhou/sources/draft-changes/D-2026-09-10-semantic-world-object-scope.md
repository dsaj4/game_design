...
- 合格素材：[语义世界的可操作对象范围](../materials/M-2026-09-10-semantic-world-object-scope.md)。
- 提案：[范围提案](../proposals/P-2026-09-10-semantic-world-object-scope.md)。
- 评估：[范围评估](../evaluations/E-2026-09-10-semantic-world-object-scope.md)，结论为推荐推进范围，证据为文档审查。
- 用户确认：[SW01原问题及“确认”](../inbox/2026-09-10-semantic-world-object-scope.md)；仅适用于该问题提出的范围。
...
同步对象：范围素材、领域词汇、决策记录G002-SCOPE-002、受影响目标与时间素材、相关索引。文件清单和检查结果见[交付记录](../../design/systems/04-elements-environment.md)。
