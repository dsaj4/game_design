...
- 用户回复“确认，一次性列出剩下需要决策的部分”，确认上下文为SW02-A推荐；[原话及资格记录](../inbox/2026-09-10-semantic-world-object-scope.md)。
- [合格引用素材](../materials/M-2026-09-10-instance-and-conditional-binding.md)，延伸既有素材，不增加素材计数。
- [引用提案](../proposals/P-2026-09-10-instance-and-conditional-binding.md)与[名单边界补充评估](../evaluations/E-2026-09-10-instance-and-conditional-binding.md)。
...
- 当前问题改为[剩余决策R01–R32](../inbox/2026-09-10-semantic-world-remaining-decisions.md)，按用户要求一次列出。
