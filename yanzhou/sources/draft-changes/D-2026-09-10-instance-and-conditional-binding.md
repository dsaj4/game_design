...
本文保留SW02采纳时文本；其中关于名单时点待定的记载属于当时状态。后续SW02-A已按[单次名单采纳](D-2026-09-10-single-release-target-list.md)确认；当前剩余问题见[总表](../inbox/2026-09-10-semantic-world-remaining-decisions.md)。
...
- [合格引用素材](../materials/M-2026-09-10-instance-and-conditional-binding.md)。
...
- [SW02用户确认记录](../inbox/2026-09-10-semantic-world-object-scope.md)：用户对两种引用并存回答“确认”。确认不包含此前注明另议的名单时点、排序与表达细则。
...
文件范围与检查记录见[本次交付](../../design/systems/01-grammar.md)。
