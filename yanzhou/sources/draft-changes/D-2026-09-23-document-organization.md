...
用户先要求结构导航、统一版本、系统分隔与规范，再要求纳入探索方向独立整理、索引与比较，最后明确“开始进行全量整理”。现行设计来源为RC1已采纳的[首版补齐提案](../proposals/P-2026-09-14-complete-first-release-design.md)、[评估](../evaluations/E-2026-09-14-complete-first-release-design.md)与[CORE-032–036](D-2026-09-14-complete-first-release-design.md)。本次是已采纳内容组织与订正，不为新机制建立虚构资格。
