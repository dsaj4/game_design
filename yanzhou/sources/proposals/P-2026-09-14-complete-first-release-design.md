...
- [首版卡池实体、角色、事件与效果组](../materials/M-2026-09-14-card-interface-completion.md)
- [首版时间、公式、卡牌参数与获取渠道](../materials/M-2026-09-14-first-release-parameters-and-channels.md)
- [首版环境形态、痕迹与转化阈值](../materials/M-2026-09-14-environment-forms-and-thresholds.md)
- [首版完整路线、敌人、遭遇、成长与疲劳](../materials/M-2026-09-14-run-route-encounters-and-fatigue.md)
- [首版玩家旅程、交互、保存与功能表现](../materials/M-2026-09-14-interface-platform-and-experience.md)
