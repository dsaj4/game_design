...
本页保留SW02与SW02-A阶段的提案/评估范围；当时未决的框架随后按[R01–R32](../materials/M-2026-09-10-semantic-world-executable-rules.md)全部采纳。当前内容设计与验证入口见[执行规则提案](P-2026-09-10-semantic-world-executable-rules.md)。
...
[实例绑定与条件绑定合格素材](../materials/M-2026-09-10-instance-and-conditional-binding.md)。包含用户随后确认的SW02-A单次名单边界；排序及其他inbox候选仍不作为规则。
