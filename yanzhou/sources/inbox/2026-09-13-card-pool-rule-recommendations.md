...
日期：2026-09-13。状态：Promoted；用户已确认RC01–12，G002-CORE-019。本文保留推荐前历史；现行规则见正式素材。
...
用户明确：“按推荐稿确认。”RC01–12整稿已采用，资格字段全部清楚，晋级[正式素材](../materials/M-2026-09-13-card-pool-rule-rulings.md)，G002-CORE-019采纳。原推荐文字保留为确认前原文；其中“待采纳／候选”描述发生时状态，现行文字以合格素材为准。

- [x] Promoted：原始表达、设计对象、玩家情境、行为、价值、系统关系与下一步均明确。
- [x] 12组共同接口的推荐选择已完成；参数和其余空间／内容缺口继续处理。
- [ ] 新规则已测试（尚未）。
...
当前FX版本与已确认卡面保持，候选关联见[登记审查入口](../../effects/readiness-review.md)。
