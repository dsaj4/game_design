...
参数设计从[数值重设计任务](../../design/parameters.md)开始；其约束进入[合格素材](../materials/M-2026-09-10-numerical-redesign-constraints.md)。[数值来源入口](2026-09-07-numerical-calibration-candidates.md)只用于追溯，不提供可直接采用的候选值。
