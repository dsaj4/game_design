...
| 来源inbox | [范围原话](../inbox/2026-09-10-semantic-world-object-scope.md)、[简化指令](../inbox/2026-09-10-simple-object-interactions.md) |
...
生成物的出现/存续/消失、具体可改变的量、点燃/冰冻效果及掉卡条件待填；反弹/非指定转移还需唯一接收规则。使用[当前代表句](../inbox/2026-09-10-semantic-sentence-cases.md)检查生成前后引用、失效跳过和资格，具体参数重新设计。
