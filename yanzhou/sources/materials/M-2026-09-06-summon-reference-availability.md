...
当前不增加专属引用词卡资源。若C03落实战前单位占位，用占位身份记录指向关系；具体占位规则仍随完整召唤流程后置，不能作为已经可用的配置功能。

单位身份保留为设计约束，具体占位与循环召唤及[实例/条件绑定](M-2026-09-10-instance-and-conditional-binding.md)一起设计；条件匹配新单位不等于继承失效实例的引用。
...
- 已确认处理范围：[C03、C04](../../governance/questions.md)。
