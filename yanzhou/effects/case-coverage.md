...
来源：[已采纳实际表](../sources/materials/M-2026-09-14-factions-wand-ranges-and-starting-loadout.md)。以下为设计例与静态核对，均非玩法测试。

| 案例 | 确定预期 | 效果与状态 |
| --- | --- | --- |
| W02锚点F3，绑定伤害敌人 | 范围F2/F3/F4/B3；含简易类型，偶数次冷却可减1，下限待PG | FX-026/r3；Accepted／NotRun |
| W02绑定火焰伤害敌人 | 显式元素执行者，不含简易；不获隔周期加速，基础十字范围仍有 | FX-026/r3 |
| W03锚点F3，有其他来源对B3施加燃烧 | B3不在横三格，不获该杖＋1；F2合格施加可获一次＋1 | FX-027/r3 |
| 护生冰霜邻接友方冰霜和中立树 | 友方冰霜可补层，中立树排除；棋盘外玩家不加入 | FX-079/r3，HG01／02 |
| W01锚点F3选F2火焰并借位 | 执行者由原范围选；目标范围F1/F2/F3/B1/B2/B3 | FX-106/r3 |
| 原木杖锚点B1 | 仅F1/F2/B1/B2，不补足六格 | WG01，全范围选取共用 |

## 2026-09-14 环境登记同步与新输入候选

| 范围 | 关系 | 当前状态 |
| --- | --- | --- |
| 当前量＋对应释放覆盖＋环境末形态检查 | FX-061/r2，CORE-022–028 | 既有规则已采纳，登记同步；NotRun |
| 烧焦等已达形态保留、不自动清空／失去火冰资格 | FX-062/r2，CORE-022／030 | 既有规则已采纳；旧BF相反候选被取代 |
| [EG实际火冰阈值与双痕迹](../sources/inbox/2026-09-14-environment-forms-and-thresholds.md) | FX-061／062的候选细化，最终转化依FX-065 | Raw／待审；不凭场景表认定已测 |
| [RG普通／首领完整疲劳](../sources/inbox/2026-09-14-run-route-encounters-and-fatigue.md) | 基础世界规则沿BR08，不新增可装配FX | 新参数及前提待审；数学上界不是运行验证 |

## 2026-09-14 HG01宿主资格

| 来源 | 正常／边界情境 | 效果关系与证据 |
| --- | --- | --- |
| [HG01](../sources/materials/M-2026-09-14-element-status-host-eligibility.md) | 玩家／敌人接受燃烧和冰冻，分别产生伤害／护甲 | FX-003/r8、FX-004/r7；Accepted／NotRun |
| HG01 | 草地／树木可持火冰层数并被合法汲取，但无生命／护甲；草地不转占位元素 | FX-003/r8、004/r7、065/r8；仅资格采纳，阈值另定 |
| HG01 | 普通石地不持火冰；火冰本体维持共享层数，不结算自身攻防 | 同上；不新增效果ID |

新[CG逐卡推荐](../sources/inbox/2026-09-14-card-interface-completion.md)为待审接口覆盖，不能视为运行或验证覆盖。
...
来源：[本轮补充](../sources/inbox/2026-09-12-element-spell-archetype.md)。下方EL-C01–07仍保存原修订关系，不是新版执行证据。
...
来源：[元素素材](../sources/materials/M-2026-09-12-element-spell-archetype.md)。本批情境是待定义规则检查，不是已执行测试。元素在抵消中消散后的余量不能自动赋予不存在宿主。

## 第一期创意卡池：50项描述与8组表达

来源：[卡池全文](../sources/inbox/2026-09-12-simple-spell-creative-card-pool.md)。以下为创意映射，50项不是50个闭合效果，也不是已通过语义验收的法术；原67项案例身份不变。
...
来源：[原话与两次确认](../sources/inbox/2026-09-12-simple-spell-archetype.md)、[方向素材](../sources/materials/M-2026-09-12-simple-spell-archetype.md)。原67项显式案例保持；下面3项是方向记录，不计为闭合执行案例。
...
来源：[类型素材TC01–TC26](../sources/materials/M-2026-09-11-spell-type-system.md)。分类原样引用，完整效果按各ID补齐。
...
来源：[简单句情境T01–T12](../sources/inbox/2026-09-10-semantic-sentence-cases.md)。这些情境的具体实现方案仍Parked；下表类型来自已明确的句子特征，未具名过程卡不是新批准词卡。
...
来源：[Modifier v0.1](../sources/materials/M-2026-09-11-modifier-card-system.md)、[Inlay v0.1](../sources/materials/M-2026-09-12-wand-inlay-system.md)。
...
来源：[EC01–EC24纸面方案](../sources/inbox/2026-09-10-element-state-drop-paper-checks.md)。这里只追踪问题覆盖，不抄入旧试案参数或标成当前唯一预期。重新启用必须逐项重新设计并冻结输入。
...
来源：[首批分类](../sources/materials/M-2026-09-11-spell-type-system.md)、[能力B01–B10](../sources/inbox/2026-09-10-semantic-ability-word-catalog.md)。
...
| 边界ID | 内容 | 所属与处理 |
| --- | --- | --- |
| ER-F01 | 疲劳双方扣血、法术禁疗 | [FAT-A／FAT-C](../sources/materials/M-2026-09-11-overtime-fatigue.md)；全局规则。FAT-A方向Accepted，细则Candidate；不是可被法术操作的状态卡 |
...
| ER-H01 | 联想／回忆等词汇操作 | [后置词汇问题](../sources/inbox/2026-09-05-vocabulary-design-questions.md)；Raw／Parked，玩家影响和配置关系Unknown，不允许战中换装 |
| ER-H02 | 爆炸、建筑倒塌、草地形态／恢复 | [战场变化来源](../sources/inbox/2026-09-10-battlefield-physical-transformations.md)；表现例子不产生范围伤害、结构破坏或资源效果；具体机制Parked |
...
| ER-H06 | 战内生命上限成长、复活、身份重置 | [支撑规则](../sources/materials/M-2026-09-07-supporting-design-rules.md)与FAT-C08边界；当前未开放，未来实际提出时登记独立效果并复审有限终局 |
| ER-H07 | 条件触发额外施法或连锁响应 | 现有GR07是声明要求，不是一张已定义“回响”卡；具体现象未提出时不虚构效果 |
| ER-H08 | 硬控制、特殊防御、永久词卡／局外强化 | 支撑规则的后置范围；名称不授予能力，未来逐效资格确认 |

## 已有测试证据的定位

[攻防Candidate v0.1](../sources/materials/M-2026-09-11-simple-spell-parameter-candidates.md)中的参数/T01–T04配置只依赖FX-001／002；[TH-001 r1报告](../development/reports/TH-2026-09-11-001-r1-run-01.md)和[r2报告](../development/reports/TH-2026-09-11-001-r2-run-01.md)仅证明各自固定输入范围。其余案例没有因被列入本表获得新执行证据。测试交接F／GR／MDT／IN-T编号保持原身份，由[TH-002 r7](../development/test-handoff.md)关联本登记。

## 第一人称格子战场案例增量

来源：[本轮合格素材](../sources/materials/M-2026-09-12-first-person-grid-battlefield.md)与[GDD v0.1](../design/systems/04-elements-environment.md)。原67项是首轮快照，本节新增关系独立编号，不改历史案例含义。
...
来源：[元素流派创意卡池](../sources/inbox/2026-09-13-element-spell-creative-card-pool.md)。对象引用不人为创造效果ID，复用旧效果不恢复旧参数；★仅初筛建议。
...
## 元素第二期30项覆盖（Raw／2026-09-13）

来源：[元素第二期机制卡池](../sources/inbox/2026-09-13-element-spell-mechanism-card-pool-02.md)。旧期保留；类型依据完整句而非输出效果，下面仅是语义示例。

| 卡ID与名称 | 效果／类型 | 状态 |
| --- | --- | --- |
| E2-V01 汲取 | FX-097；元素＋状态 | Raw／关键接口见FX |
| E2-V02 倾注 | FX-098；元素 | Raw／关键接口见FX |
| E2-V03 封存 | FX-099；简易＋元素 | Raw／关键接口见FX |
| E2-V04 解封 | FX-100；简易＋元素 | Raw／关键接口见FX |
| E2-V05 拆甲 | FX-101；元素＋状态 | Raw／关键接口见FX |
| E2-V06 对冲 | FX-102；元素 | Raw／关键接口见FX |
| E2-V07 透支 | FX-103；简易＋元素 | Raw／关键接口见FX |
| E2-V08 蓄放 | FX-104；简易＋元素 | Raw／关键接口见FX |
| E2-I01 行动炉芯 | FX-105；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I02 借位镜 | FX-106；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I03 满溢阀 | FX-107；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I04 抵消匣 | FX-108；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I05 逆温钉 | FX-109；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I06 同享镜 | FX-110；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I07 余迹钉 | FX-111；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I08 接续座 | FX-112；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I09 换能棱镜 | FX-113；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-I10 分期扣 | FX-114；镶嵌不分法术类型 | Raw／关键接口见FX |
| E2-N01 火焰 | FX-010／FX-063／FX-064 | 复用既有方向，不升级参数或资格 |
| E2-N02 冰霜 | FX-012／FX-063／FX-064 | 复用既有方向，不升级参数或资格 |
| E2-N03 燃烧 | FX-003 | 复用既有方向，不升级参数或资格 |
| E2-N04 冰冻 | FX-004 | 复用既有方向，不升级参数或资格 |
| E2-N05 护甲 | FX-002／FX-023 | 复用既有方向，不升级参数或资格 |
| E2-N06 自己 | 对象引用 | 复用既有方向，不升级参数或资格 |
| E2-A01 炽烈的 | FX-072 | 复用既有方向，不升级参数或资格 |
| E2-A02 温润的 | FX-073 | 复用既有方向，不升级参数或资格 |
| E2-A03 绵长的 | FX-074 | 复用既有方向，不升级参数或资格 |
| E2-A04 轻巧的 | FX-039 | 复用既有方向，不升级参数或资格 |
| E2-A05 护生的 | FX-079 | 复用既有方向，不升级参数或资格 |
| E2-A06 避亲的 | FX-080 | 复用既有方向，不升级参数或资格 |

## 第三期30项短规则覆盖（当前）

来源：[第三期短规则卡池](../sources/inbox/2026-09-13-element-spell-symbol-card-pool-03.md)。完整78条旧卡去向在来源附表；符号不是新句法，退出本期不删除旧案例。第二期实际30项，修正原32项计数。

| ID与名称 | FX映射 | 当前状态 |
| --- | --- | --- |
| E3-N01 火焰 | FX-010／FX-063／FX-064／FX-068 | Raw／短规则描述 |
| E3-N02 冰霜 | FX-012／FX-063／FX-064／FX-068 | Raw／短规则描述 |
| E3-N03 燃烧 | FX-003 | Raw／短规则描述 |
| E3-N04 冰冻 | FX-004 | Raw／短规则描述 |
| E3-N05 护甲 | FX-002 | Raw／短规则描述 |
| E3-V01 释放 | FX-063 | Raw／短规则描述 |
| E3-V02 汲取 | FX-097 | Raw／短规则描述 |
| E3-V03 倾注 | FX-098 | Raw／短规则描述 |
| E3-V04 消耗 | FX-023 | Raw／短规则描述 |
| E3-V05 拆甲 | FX-101 | Raw／短规则描述 |
| E3-V06 引爆 | FX-038 | Raw／短规则描述 |
| E3-V07 凝结 | FX-071 | Raw／短规则描述 |
| E3-V08 爆裂 | FX-070 | Raw／短规则描述 |
| E3-V09 净化 | FX-005／FX-006 | Raw／短规则描述 |
| E3-A01 护生的 | FX-079 | Raw／短规则描述 |
| E3-A02 避亲的 | FX-080 | Raw／短规则描述 |
| E3-A03 空心的 | FX-121 | Raw／短规则描述 |
| E3-A04 应激的 | FX-122 | Raw／短规则描述 |
| E3-A05 爆裂的 | FX-047 | Raw／短规则描述 |
| E3-A06 自噬的 | FX-123 | Raw／短规则描述 |
| E3-I01 指令芯 | FX-105 | Raw／短规则描述 |
| E3-I02 借位镜 | FX-106 | Raw／短规则描述 |
| E3-I03 满溢阀 | FX-107 | Raw／短规则描述 |
| E3-I04 同享镜 | FX-110 | Raw／短规则描述 |
| E3-I05 溢流芯 | FX-115 | Raw／短规则描述 |
| E3-I06 逆霜镜 | FX-116 | Raw／短规则描述 |
| E3-I07 止界针 | FX-117 | Raw／短规则描述 |
| E3-I08 余烬钉 | FX-118 | Raw／短规则描述 |
| E3-I09 蚀甲炉 | FX-119 | Raw／短规则描述 |
| E3-I10 返甲镜 | FX-120 | Raw／短规则描述 |

动词代表句全部类型见卡池：元素执行者＋状态宾语为元素＋状态；省略主语的状态操作为简易＋状态；冰霜倾注自己为元素，不因输出冰冻再添状态类型。净化复用FX-005／006的清除对象分支；指令芯更名复用FX-105。对语义相同条目不重复分配ID。

## 元素E3确认与简易新卡覆盖（当前）

元素E3的30项旧行在当时标为Raw，现已由用户确认并晋级[已确认元素E3素材](../sources/materials/M-2026-09-13-element-short-rule-card-pool.md)；当前使用状态为Confirmed／Qualified，未升级旧变体或参数。以下[简易短规则卡池](../sources/inbox/2026-09-13-simple-spell-short-rule-card-pool.md)仍Raw。

| 新卡 | FX映射 | 状态 |
| --- | --- | --- |
| S2-N01 敌人 | 对象引用 | Raw／待选择 |
| S2-N02 护甲 | FX-002 | Raw／待选择 |
| S2-N03 印记 | FX-035 | Raw／待选择 |
| S2-N04 回响 | FX-037／FX-033 | Raw／待选择 |
| S2-N05 冷却 | FX-018 | Raw／待选择 |
| S2-V01 伤害 | FX-001 | Raw／待选择 |
| S2-V02 获得 | FX-002／FX-037 | Raw／待选择 |
| S2-V03 标记 | FX-035 | Raw／待选择 |
| S2-V04 引爆 | FX-038 | Raw／待选择 |
| S2-V05 清除 | FX-005／FX-006／FX-032 | Raw／待选择 |
| S2-V06 完成 | FX-130 | Raw／待选择 |
| S2-A01 裸露的 | FX-131 | Raw／待选择 |
| S2-A02 反刺的 | FX-132 | Raw／待选择 |
| S2-A03 回响的 | FX-033 | Raw／待选择 |
| S2-A04 专注的 | FX-133 | Raw／待选择 |
| S2-A05 顽固的 | FX-134 | Raw／待选择 |
| S2-I01 复诵晶石 | FX-033 | Raw／待选择 |
| S2-I02 蓄势晶石 | FX-034 | Raw／待选择 |
| S2-I03 破甲回环 | FX-124 | Raw／待选择 |
| S2-I04 双律环 | FX-125 | Raw／待选择 |
| S2-I05 攻守转盘 | FX-126 | Raw／待选择 |
| S2-I06 留痕针 | FX-127 | Raw／待选择 |
| S2-I07 稳息扣 | FX-128 | Raw／待选择 |
| S2-I08 耗印芯 | FX-129 | Raw／待选择 |
| S2-I09 融冰针 | FX-055 | Raw／待选择 |

全部类型：伤害／标记敌人为简易；获得护甲／回响、引爆印记为简易＋状态；完成另一法杖冷却为简易。新规则需先选定再补句法和求值，不将法术实际产出反推类型。
