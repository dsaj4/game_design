...
本次按用户“开始进行全量整理”执行导航、去重、来源与探索隔离。原0–18章模板保留；当前规则所属页面见[权威来源表](../governance/document-contract.md)。原26组Closed仅代表当时选择记录，不能证明不存在新歧义；[AUD-010](../governance/conflict-register.md)仍待明确。
