...
文档角色：HistoricalNavigation。以下为旧目录导航；其中“当前”“活动”“下一步”均指归档前状态。新构思写入[当前方向区](../../exploration/README.md)。冻结包与机器清单保留原字节、路径和版本语境，旧脚本不直接用于现用目录。
...
- [背景包](context/README.md)、[项目约束](AGENTS.md)、[项目注册](../../../exploration/registry/project-registry.md)
