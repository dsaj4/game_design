...
> 原路径：`workspaces/game-002/docs/semantic-world-scope-adoption.md`。本副本仅调整相对链接，原字节SHA见整理清单。

# SW01语义世界对象范围采纳交付

日期：2026-09-10。状态：Accepted / Scope。决策：G002-SCOPE-002。证据：Hypothesis。基础执行基线为Core Concept v0.6。

本页记录SW01采纳时的内容、待决项和检查结果。后续SW02模型已采纳，当前交付与下一步见[两种引用采纳](../../../design/systems/01-grammar.md)；下方数量与检查结论对应当次提交04820cd。
...
- [原始表达、问题及用户确认](../../../sources/inbox/2026-09-10-semantic-world-object-scope.md)。
- [正式范围素材](../../../sources/materials/M-2026-09-10-semantic-world-object-scope.md)。
- [提案](../../../sources/proposals/P-2026-09-10-semantic-world-object-scope.md)与[评估](../../../sources/evaluations/E-2026-09-10-semantic-world-object-scope.md)。
- [采纳文本](../../../sources/draft-changes/D-2026-09-10-semantic-world-object-scope.md)、[核心](../../../design/core-concept.md)及[决策记录](../../../governance/decision-log.md)。

## 当前待决

SW02推荐具体实例绑定与条件绑定并存：前者持续指向同一对象；后者战前确定选择条件、释放时自动匹配当前对象，使符合条件的新生对象可以参与。方案比较和边界推演已保存到inbox；并存模型、名单时点、顺序及具体表达尚未采纳。

SW03–SW07继续依对象设计逐项展开。[决定清单](../../../governance/questions.md)作为当前问题入口。文档统一阶段C01–C08的完成结论保留，本记录不把新增设计分支算作已处理。
