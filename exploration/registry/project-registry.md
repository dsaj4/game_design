...
登记版本：v1.1。更新日期：2026-09-23。权威范围：探索 Project ID、路径、隔离权限和生命周期。
...
[27方向索引](../game-002-optimization/directions/README.md)与[基线/吸收](../game-002-optimization/directions/baseline-and-absorption.md)登记各批次差异。用户明确指定的来源可以按当轮范围作为补充；必须登记提交及摘要，未指定时仍使用活动包。独立肉鸽保持Blank Baseline，本次未导入任何言咒方向。
